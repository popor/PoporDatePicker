...
@implementation NSDate (PoporDatePicker)
...
{
    NSTimeInterval aTimeInterval = [[NSDate date] timeIntervalSinceReferenceDate] + PoporDatePickerDate_HOUR * dHours;
...
{
    NSTimeInterval aTimeInterval = [[NSDate date] timeIntervalSinceReferenceDate] + PoporDatePickerDate_MINUTE * dMinutes;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
    return newDate;
}
...
- (BOOL) isSameWeekAsDate: (NSDate *) aDate
{
    ...
    return (fabs([self timeIntervalSinceDate:aDate]) < PoporDatePickerDate_WEEK);
}
...
- (BOOL) isNextWeek
{
    NSTimeInterval aTimeInterval = [[NSDate date] timeIntervalSinceReferenceDate] + PoporDatePickerDate_WEEK;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
...
{
    NSTimeInterval aTimeInterval = [self timeIntervalSinceReferenceDate] + PoporDatePickerDate_HOUR * dHours;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
    return newDate;
}
...
{
    NSTimeInterval aTimeInterval = [self timeIntervalSinceReferenceDate] + PoporDatePickerDate_MINUTE * dMinutes;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
    return newDate;
}
...
- (NSInteger) minutesAfterDate: (NSDate *) aDate
{
    ...
    return (NSInteger) (ti / PoporDatePickerDate_MINUTE);
}
...
{
    NSTimeInterval ti = [self timeIntervalSinceDate:aDate];
    return (NSInteger) (ti / PoporDatePickerDate_HOUR);
}
...
{
    NSTimeInterval ti = [self timeIntervalSinceDate:aDate];
    return (NSInteger) (ti / PoporDatePickerDate_DAY);
}
...
{
    NSTimeInterval aTimeInterval = [[NSDate date] timeIntervalSinceReferenceDate] + PoporDatePickerDate_MINUTE * 30;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
